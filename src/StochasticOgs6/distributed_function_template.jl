include(joinpath("/home","bittens","workspace","OgsUQ","src","StochasticOgs6.jl"))

stoparams = read(Vector{StochasticOgs6Parameter}, "_ogsp_placeholder_")
ogsparams = read(Ogs6ProjectParams, "_ogsp_placeholder_")
